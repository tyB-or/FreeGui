...
class APP(ttk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.nootFrameRefreshBtn = ttk.Button(self.noteFrame_up,
                                              text=" 刷新GUI ",
                                              bootstyle="success")
        self.nootFrameRefreshBtn.pack(anchor=W,
                                      side=RIGHT,
                                      padx=5,
                                      pady=5,
                                      ipadx=10,
                                      ipady=10)
        self.nootFrameRefreshBtn["command"] = self.refresh
    ...
    def toolFrameFun(self):
        ...
        for i in range(5):
            self.Btnfr1 = ttk.Checkbutton(self.toolFrame,
                                          text="-",
                                          width=16,
                                          bootstyle="success-toolbutton",
                                          state="disabled").grid(pady=0,
                                                                 row=0,
                                                                 column=i)
    ...
    def saveStartCommandIniFile(self):
        ...
        self.nootFrameTxtSaveBtn['state'] = NORMAL
...
root = ttk.Window(title="FREE_GUI    一款可以自己更新的工具箱__v2.2    by：tyb-or",
                  themename="morph")
